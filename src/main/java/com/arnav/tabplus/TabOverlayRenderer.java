...
public class TabOverlayRenderer {
    ...
    public static void render(GuiGraphicsExtractor ctx, int screenWidth,
        ...
        for (int i = 0; i < players.size(); i++) {
            ...
            ctx.text(font, getDisplayText(entry), x + HEAD_SIZE + HEAD_MARGIN, y + 1, nameColor, false);
            ...
            ctx.text(font, pingStr, x + entryWidth - font.width(pingStr), y + 1, pingColor(ping), false);
        }
        ...
        if (!filterStr.isEmpty() || players.isEmpty()) {
            ...
            ctx.text(font, filterLabel, fx + PADDING, filterY, 0xFFDD44, false);
        }
